...
class _WalletScreenState extends State<WalletScreen> {
  ...
  // الخدمات الأساسية + الجديدة (مرتبة)
  ...
  final List<Map<String, dynamic>> _transactions = [
    ...
    {'name': 'شراء بطاقة أمازون', 'amount': -6240, 'date': 'أمس', 'icon': Icons.shopping_cart, 'currency': 'ر.ي'},
    {'name': 'استلام تحويل', 'amount': 10000, 'date': '22/03', 'icon': Icons.arrow_downward, 'currency': 'ر.ي'},
    {'name': 'دفع رسوم جامعة', 'amount': -3500, 'date': '20/03', 'icon': Icons.school, 'currency': 'ر.ي'},
  ];
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  Row(
                    children: [
                      Icon(Icons.wb_sunny_outlined, color: isDark ? Colors.grey[400] : Colors.orange, size: 20),
                      const SizedBox(width: 4),
                      Text('صباح الخير!', style: TextStyle(color: isDark ? Colors.grey[400] : Colors.grey[600])),
                    ],
                  ),
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.end,
                    children: [
                      const Text('أحمد محمد', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                      Text('صنعاء، اليمن', style: TextStyle(fontSize: 12, color: isDark ? Colors.grey[400] : Colors.grey[600])),
                    ],
                  ),
                ],
              ),
              ...
              child: Row(
                ...
                children: List.generate(_cards.length, (i) => AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: _currentCard == i ? _cards[i]['color'] : (isDark ? Colors.grey[700] : Colors.grey[300]),
                  ),
                )),
              ),
            ),
          ...
          SliverPadding(
            ...
            sliver: SliverGrid(
              ...
              delegate: SliverChildBuilderDelegate(
                (context, index) => _buildServiceItem(_services[index]),
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  ...
                  const Spacer(),
                  TextButton(onPressed: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => const TransactionsScreen())), child: const Text('عرض الكل')),
                ],
              ),
            ),
          ),
